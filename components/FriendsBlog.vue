  ...
  <div class="article-list">
    ...
    <header class="p-12 sm:mt-15 <md:prose-md tb:mt-30 tb:prose-lg">
      <div class="mx-auto text-center w-full">
        <h1 class="font-extrabold text-5xl dark:text-light-500"> All Friends Posts({{ allBlogs.length }}) </h1>
        <p class="font-medium text-lg dark:text-light-500"> Here's a list of all friends great articles </p>
      </div>
    </header>
    <section class="page-section">
      ...
      <Pagination v-if="allBlogs.length > 5"
        :numPages="numPages"
        :current="page" />
    </section>
  </div>
