...
export const SiteDescription = 'Nuxt, contentで構築したブログサイト'
export const ogTitle = 'annrie\'s Nuxtation'
export const twitterDescription = 'Nuxt, contentで構築したブログサイト'
export const twitterCard = 'summary_large_image'
export const twitterImage = '/twitter-card.png'
export const twitterSite = '@muraie_jin'
export const MySite = 'https://nuxtation.vercel.app/'
export const SiteLanguage = 'ja'
export const SiteImage = '/twitter-card.png'
export const SiteLogo = '/icon.png'
export const appleMobileWebAppStatusBarStyle = 'black-translucent'
export const SameAs = [
